class InstallmentsController < ApplicationController
  ...
  def mark_as_paid
    ...
    @installment.update_attributes(status: "paid")
    redirect_to :back, notice: "successfully updated to paid intallments"
  end
  ...
  private
    ...
    def installment_params
      params.require(:installment).permit(:amount, :installment_type, :description, :status, :installment_date, :project_id)
    end
end
